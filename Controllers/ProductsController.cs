...
namespace Dp_Butik.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CatalogNum,Name,Description,ImageURL,Price,DateUpdate,TypeProductId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CatalogNum,Name,Description,ImageURL,Price,DateUpdate,TypeProductId")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
